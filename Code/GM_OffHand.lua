...
function me.GetItems()
  mod.logger.LogDebug(me.tag, "Retrieving items for category: " .. GM_CONSTANTS.CATEGORIES[GM_CONSTANTS.CATEGORY_OFFHAND].name)
  return mod.common.GetItemsByType(GM_CONSTANTS.CATEGORY_OFFHAND)
end
